      ...
      <NavigationMenu className="hidden lg:block mx-auto">
        <NavigationMenuList>
          <NavigationMenuItem>
            ...
            <NavigationMenuContent>
              <ul
                className={`grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 rounded-md transition-colors duration-300 ${
              ...
              >
                {featureList.map(({ title, description, url }) => (
                  <NavigationMenuLink key={title} asChild>
                    <Link href={url}>
                      <li className="rounded-md p-3 hover:bg-muted transition-colors duration-300">
